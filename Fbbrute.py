...
def menu():
	tampil('''\rh
           ...
           {\rmX\rh}v{\rmX\rh}|\rcPRX\rh|==========.
             [']  /'|'\           \\
                 /  \  \           '
                 \_  \_ \_  \rk*\rhMaster Linuxser Indonesia
\rk########################################################
#             \rb*MULTY BRUTEFORCE FACEBOOK*\rk          #
# \rhBY : \rp Bang Jhon Islanskha \rk                    #
# \rhFB : \rp  https://m.facebook.com/MasterLinuxIndo\rk #
# \rhSite : \rp https://linuxindonesia404.blogspot.com/  #
# \rhGitHub\rp https://github.com/JhonIslanskha \rk      #
